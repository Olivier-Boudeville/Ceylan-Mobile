...
-module(mobile_delete_test).

-moduledoc """
Module for the test of the Ceylan-Mobile services regarding the (mass)
**deletion of SMS**.
""".
...
run() ->
    ...
    test_facilities:display(
        "Testing the Ceylan-Mobile service regarding the deletion of SMS." ),
    ...
    case mobile:delete_all_sms() of
        ...
        { DeletionCount, _ErrorCount=0 } ->
            test_facilities:display( "~B SMS have been successfully deleted.",
                                     [ DeletionCount ] );

        { DeletionCount, ErrorCount } ->
            trace_utils:error_fmt( "~B SMS have been successfully deleted, "
